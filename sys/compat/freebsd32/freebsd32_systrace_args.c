...
systrace_args(int sysnum, void *params, uint64_t *uarg, int *n_args)
{
	...
	case 3: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* void * */
	...
	case 4: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* const void * */
		uarg[a++] = p->nbyte; /* size_t */
		*n_args = 3;
		break;
	}
	...
	case 5: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		iarg[a++] = p->flags; /* int */
	...
	case 7: {
		...
		iarg[a++] = p->pid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->status; /* int * */
		iarg[a++] = p->options; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->rusage; /* struct rusage32 * */
		*n_args = 4;
		break;
	}
	/* link */
	case 9: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->to; /* const char * */
		*n_args = 2;
		break;
	}
	/* unlink */
	...
	case 17: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->nsize; /* char * */
		*n_args = 1;
		break;
	}
	/* getpid */
	...
	case 21: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->type; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		iarg[a++] = p->flags; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->data; /* void * */
		*n_args = 4;
		break;
	}
	/* unmount */
	...
	case 26: {
		...
		iarg[a++] = p->req; /* int */
		iarg[a++] = p->pid; /* pid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->addr; /* char * */
		iarg[a++] = p->data; /* int */
		*n_args = 4;
		break;
	}
	...
	case 27: {
		...
		iarg[a++] = p->s; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msg; /* struct msghdr32 * */
		iarg[a++] = p->flags; /* int */
		*n_args = 3;
		break;
	}
	...
	case 28: {
		...
		iarg[a++] = p->s; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msg; /* const struct msghdr32 * */
		iarg[a++] = p->flags; /* int */
		*n_args = 3;
		break;
	}
	...
	case 29: {
		...
		uarg[a++] = p->len; /* size_t */
		iarg[a++] = p->flags; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->from; /* struct sockaddr * */
		uarg[a++] = (__cheri_addr uint64_t)p->fromlenaddr; /* __socklen_t * */
		*n_args = 6;
		break;
	}
	/* accept */
	case 30: {
		...
		iarg[a++] = p->s; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->name; /* struct sockaddr * */
		uarg[a++] = (__cheri_addr uint64_t)p->anamelen; /* __socklen_t * */
		*n_args = 3;
		break;
	}
	/* getpeername */
	case 31: {
		...
		iarg[a++] = p->fdes; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->asa; /* struct sockaddr * */
		uarg[a++] = (__cheri_addr uint64_t)p->alen; /* __socklen_t * */
		*n_args = 3;
		break;
	}
	/* getsockname */
	...
	case 44: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->samples; /* char * */
	...
	case 45: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fname; /* const char * */
		iarg[a++] = p->ops; /* int */
		iarg[a++] = p->facs; /* int */
		iarg[a++] = p->pid; /* int */
		*n_args = 4;
	...
	case 49: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->namebuf; /* char * */
	...
	case 50: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->namebuf; /* const char * */
		*n_args = 1;
		break;
	}
	/* acct */
	...
	case 53: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->ss; /* const struct sigaltstack32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->oss; /* struct sigaltstack32 * */
		*n_args = 2;
		break;
	}
	/* freebsd32_ioctl */
	case 54: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = p->com; /* u_long */
		uarg[a++] = (__cheri_addr uint64_t)p->data; /* char * */
		*n_args = 3;
		break;
	}
	/* reboot */
	...
	case 57: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->link; /* const char * */
		*n_args = 2;
		break;
	}
	/* readlink */
	case 58: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* char * */
	...
	case 59: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fname; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->argv; /* uint32_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->envv; /* uint32_t * */
		*n_args = 3;
		break;
	}
	/* umask */
	...
	case 65: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->addr; /* void * */
		uarg[a++] = p->len; /* size_t */
		iarg[a++] = p->flags; /* int */
		*n_args = 3;
		break;
	...
	case 78: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->addr; /* const void * */
		uarg[a++] = p->len; /* size_t */
		uarg[a++] = (__cheri_addr uint64_t)p->vec; /* char * */
		*n_args = 3;
		break;
	}
	/* getgroups */
	case 79: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->gidset; /* gid_t * */
		*n_args = 2;
		break;
	}
	/* setgroups */
	case 80: {
		...
		iarg[a++] = p->gidsetsize; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->gidset; /* const gid_t * */
		*n_args = 2;
		break;
	}
	/* getpgrp */
	...
	case 83: {
		...
		iarg[a++] = p->which; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->itv; /* const struct itimerval32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->oitv; /* struct itimerval32 * */
		*n_args = 3;
		break;
	}
	/* swapon */
	case 85: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->name; /* const char * */
		*n_args = 1;
		break;
	}
	/* freebsd32_getitimer */
	case 86: {
		...
		iarg[a++] = p->which; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->itv; /* struct itimerval32 * */
		*n_args = 2;
		break;
	}
	/* getdtablesize */
	...
	case 93: {
		...
		iarg[a++] = p->nd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->in; /* fd_set * */
		uarg[a++] = (__cheri_addr uint64_t)p->ou; /* fd_set * */
		uarg[a++] = (__cheri_addr uint64_t)p->ex; /* fd_set * */
		uarg[a++] = (__cheri_addr uint64_t)p->tv; /* struct timeval32 * */
		*n_args = 5;
		break;
	}
	/* fsync */
	...
	case 98: {
		...
		iarg[a++] = p->s; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->name; /* const struct sockaddr * */
	...
	case 105: {
		...
		iarg[a++] = p->level; /* int */
		iarg[a++] = p->name; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->val; /* const void * */
	...
	case 116: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->tp; /* struct timeval32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->tzp; /* struct timezone * */
		*n_args = 2;
		break;
	}
	/* freebsd32_getrusage */
	...
	case 118: {
		...
		iarg[a++] = p->level; /* int */
		iarg[a++] = p->name; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->val; /* void * */
		uarg[a++] = (__cheri_addr uint64_t)p->avalsize; /* __socklen_t * */
		*n_args = 5;
		break;
	}
	/* freebsd32_readv */
	case 120: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->iovp; /* struct iovec32 * */
	...
	case 122: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->tv; /* const struct timeval32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->tzp; /* const struct timezone * */
		*n_args = 2;
		break;
	}
	/* fchown */
	...
	case 128: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->from; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->to; /* const char * */
		*n_args = 2;
		break;
	}
	...
	case 133: {
		...
		uarg[a++] = p->len; /* size_t */
		iarg[a++] = p->flags; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->to; /* const struct sockaddr * */
	...
	case 135: {
		...
		iarg[a++] = p->type; /* int */
		iarg[a++] = p->protocol; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->rsv; /* int * */
		*n_args = 4;
		break;
	}
	/* mkdir */
	...
	case 138: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->tptr; /* const struct timeval32 * */
		*n_args = 2;
		break;
	}
	/* freebsd32_adjtime */
	case 140: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->delta; /* const struct timeval32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->olddelta; /* struct timeval32 * */
		*n_args = 2;
		break;
	}
	/* setsid */
	...
	case 148: {
		...
		iarg[a++] = p->cmd; /* int */
		iarg[a++] = p->uid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->arg; /* void * */
		*n_args = 4;
		break;
	}
	/* getfh */
	case 161: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fname; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->fhp; /* struct fhandle * */
		*n_args = 2;
		break;
	}
	/* freebsd32_sysarch */
	case 165: {
		...
		iarg[a++] = p->op; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->parms; /* char * */
		*n_args = 2;
		break;
	}
	/* rtprio */
	case 166: {
		...
		iarg[a++] = p->pid; /* pid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->rtp; /* struct rtprio * */
		*n_args = 3;
		break;
	}
	/* freebsd32_semsys */
	...
	case 176: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->tp; /* struct timex32 * */
		*n_args = 1;
		break;
	}
	/* setgid */
	...
	case 194: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->rlp; /* struct rlimit * */
		*n_args = 2;
		break;
	}
	/* setrlimit */
	...
	case 202: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->name; /* int * */
		uarg[a++] = p->namelen; /* u_int */
		uarg[a++] = (__cheri_addr uint64_t)p->old; /* void * */
		uarg[a++] = (__cheri_addr uint64_t)p->oldlenp; /* uint32_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->new; /* const void * */
	...
	case 209: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fds; /* struct pollfd * */
		uarg[a++] = p->nfds; /* u_int */
	...
	case 222: {
		...
		iarg[a++] = p->semid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->sops; /* struct sembuf * */
	...
	case 226: {
		...
		iarg[a++] = p->msqid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msgp; /* const void * */
	...
	case 227: {
		...
		iarg[a++] = p->msqid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msgp; /* void * */
		uarg[a++] = p->msgsz; /* size_t */
	...
	case 228: {
		...
		iarg[a++] = p->shmid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->shmaddr; /* const void * */
		iarg[a++] = p->shmflg; /* int */
		*n_args = 3;
		break;
	}
	...
	case 232: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->tp; /* struct timespec32 * */
		*n_args = 2;
		break;
	}
	...
	case 233: {
		...
		iarg[a++] = p->clock_id; /* clockid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->tp; /* const struct timespec32 * */
		*n_args = 2;
		break;
	}
	...
	case 235: {
		...
		iarg[a++] = p->clock_id; /* clockid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->evp; /* struct sigevent32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->timerid; /* int * */
		*n_args = 3;
		break;
	}
	/* ktimer_delete */
	...
	case 237: {
		...
		iarg[a++] = p->timerid; /* int */
		iarg[a++] = p->flags; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->value; /* const struct itimerspec32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->ovalue; /* struct itimerspec32 * */
		*n_args = 4;
		break;
	}
	...
	case 238: {
		...
		iarg[a++] = p->timerid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->value; /* struct itimerspec32 * */
		*n_args = 2;
		break;
	}
	/* ktimer_getoverrun */
	...
	case 240: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->rqtp; /* const struct timespec32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->rmtp; /* struct timespec32 * */
		*n_args = 2;
		break;
	}
	/* ffclock_getcounter */
	case 241: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->ffcount; /* ffcounter * */
		*n_args = 1;
		break;
	}
	...
	case 242: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->cest; /* struct ffclock_estimate32 * */
		*n_args = 1;
		break;
	}
	...
	case 247: {
		...
		iarg[a++] = p->which; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->clock_id; /* clockid_t * */
		*n_args = 4;
		break;
	}
	/* minherit */
	...
	case 255: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->aiocbp; /* struct aiocb32 * */
		*n_args = 1;
		break;
	}
	/* freebsd32_aio_write */
	...
	case 257: {
		...
		iarg[a++] = p->mode; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->acb_list; /* uint32_t * */
		iarg[a++] = p->nent; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->sig; /* struct sigevent32 * */
		*n_args = 4;
		break;
	}
	/* kbounce */
	case 258: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->src; /* const void * */
		uarg[a++] = (__cheri_addr uint64_t)p->dst; /* void * */
		uarg[a++] = p->len; /* size_t */
		iarg[a++] = p->flags; /* int */
		*n_args = 4;
		break;
	...
	case 259: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->message; /* const char * */
	...
	case 298: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->u_fhp; /* const struct fhandle * */
		iarg[a++] = p->flags; /* int */
		*n_args = 2;
		break;
	}
	...
	case 301: {
		...
		iarg[a++] = p->modid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->stat; /* struct module_stat32 * */
		*n_args = 2;
		break;
	}
	/* modfnext */
	...
	case 304: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->file; /* const char * */
		*n_args = 1;
		break;
	}
	/* kldunload */
	...
	case 308: {
		...
		iarg[a++] = p->fileid; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->stat; /* struct kld_file_stat32 * */
		*n_args = 2;
		break;
	}
	/* kldfirstmod */
	...
	case 315: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->aiocbp; /* uint32_t * */
		iarg[a++] = p->nent; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->timeout; /* const struct timespec32 * */
		*n_args = 3;
		break;
	}
	...
	case 327: {
		...
		iarg[a++] = p->pid; /* pid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->param; /* const struct sched_param * */
		*n_args = 2;
		break;
	}
	/* sched_getparam */
	case 328: {
		...
		iarg[a++] = p->pid; /* pid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->param; /* struct sched_param * */
		*n_args = 2;
		break;
	}
	/* sched_setscheduler */
	...
	case 334: {
		...
		iarg[a++] = p->pid; /* pid_t */
		uarg[a++] = (__cheri_addr uint64_t)p->interval; /* struct timespec32 * */
		*n_args = 2;
		break;
	}
	/* utrace */
	...
	case 338: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->jailp; /* struct jail32 * */
		*n_args = 1;
		break;
	}
	/* sigprocmask */
	case 340: {
		...
		iarg[a++] = p->how; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->set; /* const sigset_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->oset; /* sigset_t * */
		*n_args = 3;
		break;
	}
	/* sigsuspend */
	case 341: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->sigmask; /* const sigset_t * */
		*n_args = 1;
		break;
	}
	/* sigpending */
	case 343: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->set; /* sigset_t * */
		*n_args = 1;
		break;
	}
	...
	case 345: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->set; /* const sigset_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->info; /* struct siginfo32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->timeout; /* const struct timespec32 * */
		*n_args = 3;
		break;
	}
	...
	case 347: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->aclp; /* struct acl * */
		*n_args = 3;
		break;
	}
	/* __acl_set_file */
	...
	case 355: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->filename; /* const char * */
		iarg[a++] = p->attrnamespace; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->attrname; /* const char * */
		*n_args = 5;
		break;
	}
	/* extattr_set_file */
	...
	case 359: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->aiocbp; /* uint32_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->timeout; /* struct timespec32 * */
		*n_args = 2;
		break;
	}
	/* getresuid */
	case 360: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->ruid; /* uid_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->euid; /* uid_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->suid; /* uid_t * */
		*n_args = 3;
		break;
	}
	/* getresgid */
	case 361: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->rgid; /* gid_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->egid; /* gid_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->sgid; /* gid_t * */
		*n_args = 3;
		break;
	}
	/* kqueue */
	...
	case 390: {
		...
		iarg[a++] = p->what; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->name; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->value; /* char * */
		iarg[a++] = p->len; /* int */
		*n_args = 4;
		break;
	}
	...
	case 392: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->store; /* struct uuid * */
		iarg[a++] = p->count; /* int */
		*n_args = 2;
		break;
	}
	...
	case 393: {
		...
		uarg[a++] = p->offset2; /* uint32_t */
		uarg[a++] = p->nbytes; /* size_t */
		uarg[a++] = (__cheri_addr uint64_t)p->hdtr; /* struct sf_hdtr32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->sbytes; /* off_t * */
		iarg[a++] = p->flags; /* int */
		*n_args = 8;
		break;
	}
	...
	case 404: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->idp; /* int32_t * */
	...
	case 407: {
		...
		iarg[a++] = p->id; /* int32_t */
		uarg[a++] = (__cheri_addr uint64_t)p->val; /* int * */
		*n_args = 2;
		break;
	}
	/* ksem_destroy */
	...
	case 416: {
		...
		iarg[a++] = p->sig; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->act; /* const struct sigaction32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->oact; /* struct sigaction32 * */
		*n_args = 3;
		break;
	}
	/* freebsd32_sigreturn */
	case 417: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->sigcntxp; /* const struct __ucontext32 * */
		*n_args = 1;
		break;
	}
	...
	case 421: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->ucp; /* struct __ucontext32 * */
		*n_args = 1;
		break;
	}
	...
	case 422: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->ucp; /* const struct __ucontext32 * */
		*n_args = 1;
		break;
	}
	...
	case 423: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->oucp; /* struct __ucontext32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->ucp; /* const struct __ucontext32 * */
		*n_args = 2;
		break;
	}
	...
	case 429: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->set; /* const sigset_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->sig; /* int * */
		*n_args = 2;
		break;
	}
	/* thr_exit */
	case 431: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->state; /* int32_t * */
		*n_args = 1;
		break;
	}
	/* thr_self */
	case 432: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->id; /* int32_t * */
		*n_args = 1;
		break;
	}
	/* thr_kill */
	...
	case 441: {
		...
		iarg[a++] = p->id; /* int32_t */
		uarg[a++] = (__cheri_addr uint64_t)p->abstime; /* const struct timespec32 * */
		*n_args = 2;
		break;
	}
	...
	case 445: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->record; /* const void * */
	...
	case 447: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->auid; /* uid_t * */
		*n_args = 1;
		break;
	}
	/* setauid */
	...
	case 449: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->auditinfo; /* struct auditinfo * */
		*n_args = 1;
		break;
	}
	/* setaudit */
	...
	case 451: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->auditinfo_addr; /* struct auditinfo_addr * */
		uarg[a++] = p->length; /* u_int */
		*n_args = 2;
		break;
	}
	...
	case 454: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->obj; /* void * */
		iarg[a++] = p->op; /* int */
		uarg[a++] = p->val; /* u_long */
		uarg[a++] = (__cheri_addr uint64_t)p->uaddr1; /* void * */
		uarg[a++] = (__cheri_addr uint64_t)p->uaddr2; /* void * */
		*n_args = 5;
		break;
	}
	/* freebsd32_thr_new */
	case 455: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->param; /* struct thr_param32 * */
	...
	case 456: {
		...
		iarg[a++] = p->pid; /* pid_t */
		iarg[a++] = p->signum; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->value; /* void * */
		*n_args = 3;
		break;
	}
	/* freebsd32_kmq_open */
	case 457: {
		...
		iarg[a++] = p->flags; /* int */
		iarg[a++] = p->mode; /* mode_t */
		uarg[a++] = (__cheri_addr uint64_t)p->attr; /* const struct mq_attr32 * */
		*n_args = 4;
		break;
	}
	...
	case 458: {
		...
		iarg[a++] = p->mqd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->attr; /* const struct mq_attr32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->oattr; /* struct mq_attr32 * */
		*n_args = 3;
		break;
	}
	...
	case 459: {
		...
		iarg[a++] = p->mqd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msg_ptr; /* char * */
		uarg[a++] = p->msg_len; /* size_t */
		uarg[a++] = (__cheri_addr uint64_t)p->msg_prio; /* unsigned * */
		uarg[a++] = (__cheri_addr uint64_t)p->abs_timeout; /* const struct timespec32 * */
		*n_args = 5;
		break;
	}
	...
	case 460: {
		...
		iarg[a++] = p->mqd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msg_ptr; /* const char * */
		uarg[a++] = p->msg_len; /* size_t */
	...
	case 461: {
		...
		iarg[a++] = p->mqd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->sigev; /* const struct sigevent32 * */
		*n_args = 2;
		break;
	}
	/* kmq_unlink */
	...
	case 463: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->why; /* const char * */
		iarg[a++] = p->nargs; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->args; /* uint32_t * */
		*n_args = 3;
		break;
	}
	/* thr_set_name */
	...
	case 472: {
		...
		iarg[a++] = p->sd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->msg; /* void * */
		iarg[a++] = p->mlen; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->to; /* const struct sockaddr * */
		iarg[a++] = p->tolen; /* __socklen_t */
		uarg[a++] = (__cheri_addr uint64_t)p->sinfo; /* struct sctp_sndrcvinfo * */
		iarg[a++] = p->flags; /* int */
		*n_args = 7;
		break;
	}
	...
	case 473: {
		...
		iarg[a++] = p->sd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->iov; /* struct iovec32 * */
		iarg[a++] = p->iovlen; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->to; /* const struct sockaddr * */
		iarg[a++] = p->tolen; /* __socklen_t */
		uarg[a++] = (__cheri_addr uint64_t)p->sinfo; /* struct sctp_sndrcvinfo * */
	...
	case 474: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fromlenaddr; /* __socklen_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->sinfo; /* struct sctp_sndrcvinfo * */
		uarg[a++] = (__cheri_addr uint64_t)p->msg_flags; /* int * */
		*n_args = 7;
		break;
	}
	/* freebsd32_pread */
	...
	case 484: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->setid; /* cpusetid_t * */
		*n_args = 1;
		break;
	}
	...
	case 487: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->mask; /* cpuset_t * */
		*n_args = 6;
		break;
	}
	...
	case 488: {
		...
		uarg[a++] = p->id2; /* uint32_t */
		uarg[a++] = p->cpusetsize; /* size_t */
		uarg[a++] = (__cheri_addr uint64_t)p->mask; /* const cpuset_t * */
		*n_args = 6;
		break;
	}
	/* faccessat */
	...
	case 494: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->times; /* const struct timeval32 * */
		*n_args = 3;
		break;
	}
	/* linkat */
	case 495: {
		...
		iarg[a++] = p->fd1; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->path1; /* const char * */
		iarg[a++] = p->fd2; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->path2; /* const char * */
		iarg[a++] = p->flag; /* int */
		*n_args = 5;
		break;
	}
	...
	case 501: {
		...
		iarg[a++] = p->oldfd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->old; /* const char * */
		iarg[a++] = p->newfd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->new; /* const char * */
		*n_args = 4;
		break;
	}
	/* symlinkat */
	...
	case 510: {
		...
		iarg[a++] = p->semnum; /* int */
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->arg; /* union semun32 * */
		*n_args = 4;
		break;
	}
	/* freebsd32_msgctl */
	case 511: {
		...
		iarg[a++] = p->msqid; /* int */
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* struct msqid_ds32 * */
		*n_args = 3;
		break;
	}
	/* freebsd32_shmctl */
	case 512: {
		...
		iarg[a++] = p->shmid; /* int */
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* struct shmid_ds32 * */
		*n_args = 3;
		break;
	}
	/* lpathconf */
	...
	case 515: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->rightsp; /* cap_rights_t * */
		*n_args = 3;
		break;
	}
	/* cap_enter */
	...
	case 517: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->modep; /* u_int * */
		*n_args = 1;
		break;
	}
	/* pdfork */
	case 518: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fdp; /* int * */
		iarg[a++] = p->flags; /* int */
		*n_args = 2;
		break;
	}
	...
	case 520: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->pidp; /* pid_t * */
		*n_args = 2;
		break;
	}
	/* freebsd32_pselect */
	case 522: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->ou; /* fd_set * */
		uarg[a++] = (__cheri_addr uint64_t)p->ex; /* fd_set * */
		uarg[a++] = (__cheri_addr uint64_t)p->ts; /* const struct timespec32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->sm; /* const sigset_t * */
		*n_args = 6;
		break;
	}
	/* getloginclass */
	...
	case 525: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->inbufp; /* const void * */
		uarg[a++] = p->inbuflen; /* size_t */
		uarg[a++] = (__cheri_addr uint64_t)p->outbufp; /* void * */
	...
	case 532: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->status; /* int * */
		iarg[a++] = p->options; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->wrusage; /* struct __wrusage32 * */
		uarg[a++] = (__cheri_addr uint64_t)p->info; /* struct siginfo32 * */
		*n_args = 8;
		break;
	}
	...
	case 534: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->cmds; /* const uint32_t * */
	...
	case 535: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->cmds; /* uint32_t * */
	...
	case 537: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->fcntlrightsp; /* uint32_t * */
		*n_args = 2;
		break;
	}
	/* bindat */
	...
	case 542: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->fildes; /* int * */
		iarg[a++] = p->flags; /* int */
		*n_args = 2;
		break;
	}
	...
	case 546: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->times; /* const struct timespec32 * */
		*n_args = 2;
		break;
	}
	/* freebsd32_utimensat */
	...
	case 551: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->sb; /* struct stat32 * */
		*n_args = 2;
		break;
	}
	/* freebsd32_fstatat */
	case 552: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* struct stat32 * */
		iarg[a++] = p->flag; /* int */
		*n_args = 4;
		break;
	}
	...
	case 554: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* char * */
		uarg[a++] = p->count; /* size_t */
		uarg[a++] = (__cheri_addr uint64_t)p->basep; /* off_t * */
		*n_args = 4;
		break;
	}
	/* statfs */
	case 555: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->buf; /* struct statfs * */
		*n_args = 2;
		break;
	}
	/* fstatfs */
	...
	case 560: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->changelist; /* const struct kevent32 * */
		iarg[a++] = p->nchanges; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->eventlist; /* struct kevent32 * */
	...
	case 561: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->mask; /* domainset_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->policy; /* int * */
		*n_args = 7;
		break;
	}
	...
	case 564: {
		...
		iarg[a++] = p->fd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->path; /* char * */
		uarg[a++] = (__cheri_addr uint64_t)p->fhp; /* struct fhandle * */
		iarg[a++] = p->flags; /* int */
		*n_args = 4;
		break;
	...
	case 569: {
		...
		iarg[a++] = p->infd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->inoffp; /* off_t * */
		iarg[a++] = p->outfd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->outoffp; /* off_t * */
		uarg[a++] = p->len; /* size_t */
		uarg[a++] = p->flags; /* unsigned int */
		*n_args = 6;
		break;
	...
	case 570: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->old; /* void * */
		uarg[a++] = (__cheri_addr uint64_t)p->oldlenp; /* uint32_t * */
		uarg[a++] = (__cheri_addr uint64_t)p->new; /* void * */
		uarg[a++] = p->newlen; /* size_t */
		*n_args = 6;
		break;
	}
	...
	case 572: {
		...
		uarg[a++] = (__cheri_addr uint64_t)p->path_from; /* const char * */
		uarg[a++] = (__cheri_addr uint64_t)p->path_to; /* const char * */
		iarg[a++] = p->flags; /* int */
		*n_args = 3;
		break;
	}
	...
	case 573: {
		...
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->ptr; /* uint32_t * */
		*n_args = 2;
		break;
	}
	/* __realpathat */
	...
	case 577: {
		...
		iarg[a++] = p->type; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->req; /* const void * */
		uarg[a++] = p->len; /* size_t */
		*n_args = 3;
		break;
	}
	...
	case 580: {
		...
		iarg[a++] = p->fd; /* int */
		iarg[a++] = p->cmd; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->rqsr; /* const struct spacectl_range * */
		iarg[a++] = p->flags; /* int */
		uarg[a++] = (__cheri_addr uint64_t)p->rmsr; /* struct spacectl_range * */
		*n_args = 5;
		break;
	}
	/* sched_getcpu */
